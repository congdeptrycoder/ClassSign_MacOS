...
const ThemeProvider = ({ children }) => {
  ...
  const value = reactExports.useMemo(() => {
    ...
    return {
      theme,
      isDark: isDark2,
      colors: isDark2 ? darkColors : lightColors,
      toggleTheme
    };
  }, [theme, toggleTheme]);
  reactExports.useEffect(() => {
    ...
    Object.entries(colors).forEach(([key, val]) => {
      if (Array.isArray(val)) {
        root2.style.setProperty(`--${key}-start`, val[0]);
        root2.style.setProperty(`--${key}-end`, val[1]);
      } else {
...
const LoginScreen = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "theme-toggle-btn", onClick: toggleTheme, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "icon", children: isDark ? "☀️" : "🌙" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text", children: isDark ? "Giao diện Sáng" : "Giao diện Tối" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-card card", children: [
...
const AdminDashboard = () => {
  ...
  const onNavigateToEdit = (item) => navigate("/admin/edit", { state: { classData: item } });
  const {
    isProfileOpen,
    toggleProfile,
    handleLogout,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "admin-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "nav-bar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-left", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-title", children: "Quản trị hệ thống" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-right", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-trigger", onClick: toggleProfile, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hustLogo, alt: "Avatar", className: "avatar" }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "admin-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "registration-setup card", style: { display: "flex", flexDirection: "column", gap: "15px", marginBottom: "20px" }, children: [
        ...
        isEditingPeriod ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "20px", alignItems: "center", flexWrap: "wrap" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "10px", alignItems: "center" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Từ:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "datetime-local",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "10px", alignItems: "center" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Đến:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "datetime-local",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "table-wrapper card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-scroll", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "admin-table", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: classesData.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: item.phong_hoc }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "action-cell", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "delete-btn", onClick: () => handleDelete(item), children: "Xoá" })
          ] }) })
        ] }, idx)) })
      ] }) }) })
    ] }),
...
const StudentDashboard = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "student-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "nav-bar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hustLogo, alt: "Logo", className: "nav-logo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-title", children: "Đăng ký học tập" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "icon-btn", onClick: toggleTheme, children: isDark ? "☀️" : "🌙" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-trigger", onClick: toggleUserInfo, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hustLogo, alt: "Avatar", className: "avatar" }) })
      ] })
    ] }),
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React$2.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
